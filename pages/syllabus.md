...
* A Text Editor such as [VS Code](https://code.visualstudio.com/), [VSCodium](https://vscodium.com/) (community version, no telemetry), [Sublime Text](https://www.sublimetext.com/). Students are free to use the editor of their choice, though VS Code/VSCodium has the nice L5lua extension.
* [L5 website](https://l5lua.org) This is the site and reference for L5 coding library.
...
The primary language (library) we use in the course is L5.

* [L5 Reference](http://l5lua.org/reference)
* [Field Guide to Debugging](https://p5js.org/tutorials/field-guide-to-debugging/)
* [L5 on Processing forum](https://discourse.processing.org/c/l5/29)
